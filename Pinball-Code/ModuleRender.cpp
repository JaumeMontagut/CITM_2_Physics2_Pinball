...
// Blit to screen
bool ModuleRender::Blit(SDL_Texture* texture, int x, int y, SDL_Rect* section, float speed, double angle, int pivot_x, int pivot_y, SDL_RendererFlip flipFlag)
{
	bool ret = true;
	SDL_Rect rect;
	...
	if(SDL_RenderCopyEx(renderer, texture, section, &rect, angle, p, flipFlag) != 0)
	{
